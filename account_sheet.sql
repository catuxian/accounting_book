...
CREATE TABLE `items` (
  ...
  `item` varchar(24) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '項目名稱',
  `payment` int(24) UNSIGNED NOT NULL COMMENT '金額',
  `type` tinyint(2) UNSIGNED NOT NULL COMMENT '類別'
